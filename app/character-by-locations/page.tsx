...
const CharacterByLocationsPage = () => {
    return (
        <div>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa distinctio dolorem dolorum ea facere fuga
                fugiat id iste iure laudantium quasi, quisquam rem soluta vitae voluptate! Commodi facere vitae
                voluptatum!</p>
        </div>
    )
}
